...
class _DoctorPrescriptionCreatorPageState
  ...
  Future<void> _savePrescription({bool printAfterSave = true}) async {
    ...
    final prescription = Prescription(
      ...
      oe: _testCtrl.text.trim().isEmpty ? null : _testCtrl.text.trim(),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                _patientMetaChip(Icons.wc_outlined, _gender),
                                const SizedBox(width: 10),
                                _patientMetaChip(
            ...
            builder: (context, constraints) {
              ...
              final rightPane = _sectionCard(
                ...
                trailing: TextButton.icon(
                  ...
                  onPressed: () =>
                      setState(() => _medications.add(_MedicationRowData())),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      style: const TextStyle(fontSize: 14),
                      decoration: InputDecoration(
                        hintText: 'Advise on diet, rest, or follow-up tests...',
                        filled: true,
                        ...
                        Container(
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                              colors: [Color(0xFF1E4DA1), Color(0xFF0369A1)],
                            ),
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: FilledButton.icon(
                            ...
                            label: Text(
                              _isSaving ? 'Saving...' : 'Save, E-Sign & Print',
                            ),
                          ),
                        ),
                      ],
